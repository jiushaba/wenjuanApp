...
public class CameraManager {
     ...
     * 定义图片保存的路径和图片的名字
     */
    public final static String PHOTO_PATH = "mnt/sdcard/wenjuan/image/";
    public  String key;
    public  String questionId;
    public void setImageName(String key,String questionId) {
        this.key = key;
        this.questionId = questionId;
    }
    public  String getPhotoFileName() {

        return  key+"_"+questionId+".jpg";
    }
